export const translations = {
    fr: {
        ...
        explorer: {
            ...
            subtitle: 'Découvrez des films à ajouter à votre collection.',
            searchResults: 'Suggestions de films',
            search: 'Rechercher',
            noResults: 'Désolé, nous n\'avons trouvé aucun résultat.',
            results: 'Résultats pour',
            matchingMovies: 'Nous avons trouvé ${movies.length} films correspondants.',
            trending: 'Tendances',
        ...
        library: {
            ...
            toWatch: 'À regarder',
            watched: 'Regardés',
            noMovies: 'Ajoutez des films à voir depuis Explorer',
            noWatched: 'Marquez des films comme vus',
            watchlist: 'Watchlist',
    ...
    en: {
        ...
        explorer: {
            title: 'Explorer',
            overview: 'Overview',
            subtitle: 'Discover movies to add to your collection.',
            searchResults: 'Movie suggestions',
            search: 'Search',
            noResults: 'No movies found for this search.',
            results: 'Results for',
            matchingMovies: 'We found ${movies.length} matching movies.',
            trending: 'Trending',
        ...
        library: {
            ...
            toWatch: 'To Watch',
            watched: 'Watched',
            noMovies: 'Add movies to watch from Explorer',
            noWatched: 'Mark movies as watched',
            watchlist: 'Watchlist',
